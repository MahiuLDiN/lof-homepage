    ...
    <>
     ...
     <div>
         <div className="text-white mainPrivacy-txt">
            ...
            <br />
            <p>This Policy does not apply to other companies&rsquo; or Companys&rsquo; websites to which we may link to or may link to us. You should carefully review the privacy policies of those sites in order to determine how they treat your personal information.</p>
            <br />
     ...
     <div>
         ...
         <ul>
             ...
             <li><span>Consent - </span> is any freely given, specific, informed and unambiguous indication of data subject&rsquo;s acceptance to the processing of their personal data.</li>
         </ul>  
         </div>
     </div>
     <div>
...
<ul>
<li><span>General Data Protection Regulation </span> is any freely given, specific, informed and unambiguous indication of data subject&rsquo;s acceptance to the processing of their personal data.</li>
<li><span>California Consumer Privacy Act </span> is any freely given, specific, informed and unambiguous indication of data subject&rsquo;s acceptance to the processing of their personal data.</li>
</ul>
...
The source of the usage data is our analytics tracking system. This usage data may be processed for the purposes of analyzing the use of the website and services.</p>
     ...
     <div>
        ...
        <ul>
            <li>To protect the privacy of your data, which is a top priority for our company&rsquo;s management;</li>
     ...
     <div>
         <div className="pt-10 text-white defination-part">
           <h4 className="pb-3" >What Happens If You Don&rsquo;t Give Us Your Personal Data</h4>
     ...
     <div>
         <div className="pt-10 text-white defination-part">
           <h4 className="pb-3" >What are your data protection rights?</h4>
            ...
            <br />
            <p><span>The right to be informed &ndash;</span> You have the right to be informed about the personal data we collect from you, and how we process it.</p>
            <p><span>The right to access &ndash;</span> You have the right to request Lonelyfans for copies of your personal data. We may charge you a small fee for this service.</p>
            <p><span>The right to rectification &ndash;</span> You have the right to request that Lonelyfans correct any information you believe is inaccurate. You also have the right to request Lonelyfans to complete the information you believe is incomplete.</p>
            <p><span>The right to erasure &ndash;</span> You have the right to request that Lonelyfans erase your personal data, under certain conditions.</p>
            <p><span>The right to restrict processing &ndash;</span> You have the right to request that Lonelyfans restrict the processing of your personal data, under certain conditions.</p>
            <p><span>The right to object to processing &ndash;</span> You have the right to object to Lonelyfans&rsquo;s processing of your personal data, under certain conditions.</p>
            <p><span>The right to data portability &ndash;</span> You have the right to request that Lonelyfans transfer the data that we have collected to another Company, or directly to you, under certain conditions.</p>
            <br />
     ...
     <div>
        ...
        <ul>
            <li>Functionality &ndash; Lonelyfans uses these cookies so that we recognize you on our website and remember your previously selected preferences. These could include what language you prefer and the location you are in. A mix of first-party and third-party cookies are used. Lonelyfans uses these cookies to collect information about your visit to our website, the content you viewed, the links you followed, and information about your browser, device, and your IP address.</li>
            <li>Strictly Necessary cookies&ndash; let you move around the website and use essential features like secure areas. Without these cookies, we cannot provide the requested services.We use these strictly necessary cookies to:
           ...
           <br/><span className="circleSpan"> o </span>For security purposes
            ...
            <li>&lsquo;Performance&rsquo; cookies &ndash; collect information about how you use the website, e.g. which pages you visit, and if you experience any errors. These cookies do not collect any information that could identify you and are only used to help us improve how the website works. We use performance cookies to:
     ...
     <div>
         <div className="pt-10 text-white defination-part">
           <h4 className="pb-3">How to contact us</h4>
            <p>If you have any questions about Lonelyfans&rsquo;s privacy policy, the data we hold on you, or you would like to exercise one of your data protection rights, please do not hesitate to contact us at contact@lofcrypto.com.</p>
           </div>
     </div>
     ...
     <div>
         <div className="pt-10 text-white defination-part">
           ...
           <p>We only retain the personal information collected from a User for as long as the User&rsquo;s account is active on our platform, or otherwise for a limited period of time as long as we need it to fulfill the purposes for which we have initially collected it, unless otherwise required by law.
            <br/>
